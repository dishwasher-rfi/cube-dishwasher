...
from PyQt5.QtWidgets import (QMainWindow, QSplitter, QMessageBox, QFileDialog, QListWidget, QListWidgetItem, QPushButton, QSizePolicy)
from PyQt5.QtCore import (QSize, QT_VERSION_STR, PYQT_VERSION_STR, Qt)
...
class RectZoomToolsig(RectZoomTool):
    # +++ SIG_PLOT_AXIS_CHANGED = signal.signal()
...
class BaseCurveWidget2(QSplitter):
    ...
    def __init__(self, parent=None, title=None,
        ...
        QSplitter.__init__(self, Qt.Vertical, main=self)
...
#        self.imagelist.addItems([image.title for image in self.images])
    ...
    def fitfile(self):
        ...
        name = QFileDialog.getSaveFileName(self, _("Save File"),
...
#        self.imagelist.addItems([image.title for image in self.images])
    ...
    def apply_fit(self):
        ...
        #filename = QFileDialog.getOpenFileName(self, _("Correction file"), self.data_ref.dir_name+"/"+basename(normpath(self.data_ref.dir_name)+"_fit."+self.data_ref.files_type))
        try:
...
class MainWindow(QMainWindow):
    ...
    def _open(self):
        ...
        if dirname:
            ...
            cfeeds.set(self.data.list2choices(list(self.data.sections.keys())))
            csections.set(self.data.list2choices(list(self.data.sections.values())[0]))
