...
class OpenCommand(Command):
    ...
    * execute: execute the command
    ...
    def __init__(self, dw_data, file_name, file_type, file_index, file_mode):
        """
        ...
        if file_mode == 'single':
           ...
           self.file_name = file_name[file_index]
        ...
        if file_mode == 'single':
           ...
           self.data.file_name = file_name[file_index]
        self.data.file_list = file_name
        self.data.file_index = file_index
        self.data.file_type = file_type
        self.data.file_mode = file_mode
    ...
    def execute(self):
        ...
        for i_dataset in range(len(self.data.datasets)):
            ...
            try:
                ...
                self.data.datasets[i_dataset].t = "Unknown"
...
class OpenDirCommand(Command):
    ...
    def execute(self):
        ...
        for i_dataset in range(len(self.data.dir_datasets)):
...
class DelFlagSetCommand(Command):
    ...
    * execute: execute the command
    ...
    def __init__(self, dw_data, i_dataset, k_flagset, filelist):
        """
        dw_data: dw.core.data_def instance
    ...
    def execute(self):
        ...
        if type(self.filelist) == list:
           ret = self.data.dw_io.del_all_table(self.filelist,
...
class AutoFlagComputeCommand(Command):
    ...
    * execute: execute the command
    ...
    def execute(self):
        ...
        flag_list = list(self.data.selected_dect_alg.compute().values())
