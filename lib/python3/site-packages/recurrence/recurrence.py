...
def count_seq(x):
    ...
    if len(start[0]):
        d = stop[0]-start[0]+1
        for ll in range (np_max((np_min(d),2)), np_max(d)+1):
...
##                print q.get(),
    ...
    def rqa_l_freq_dist(self, th):
        ...
        try:
            ...
            for dd in range (range_start, self.rplot.shape[0]):
    ...
    def rqa_v_freq_dist(self, th):
        ...
        try:
            ...
            for dd in range (0, self.rplot.shape[0]):
    ...
    def _rqa_lv_dist_min(self, th, m_min, freq_dist, ret_sum = 0):
        l = np_array([])
        p = np_array([])
        for item in list(freq_dist(th).items()):
    ...
    def _rqa_lv_max(self, th, freq_dist, measure_dict, offset):
        ...
        try:
            ...
            d = freq_dist(th)
            n = np_hstack((1,np_array(list(d.values()))))
            l = np_hstack((0,np_array(list(map(int, list(d.keys()))))))
